...
const Banner = () => {
    return (
        <div className=' py-40 text-center text-white mx-3'>
            ...
            <button className='bg-blue-500 mt-20 text-2xl hover:text-blue-500 duration-500  hover:bg-white font-semibold py-6 px-20 rounded-full flex mx-auto gap-2 items-center '>
                Apply Today
                <FaArrowRight />
                </button>
        </div>
