...
const Banner = () => {
    return (
        <div className=' md:py-40 py-2 text-center text-white '>
            ...
            <Link href={"/apply-now"}>
            <button className='bg-blue-500 flex-shrink-0 md:mt-20 mt-4 2xl:text-[22px] xl:text-[20px] lg:text-[18px] md:text-[16px] text-[14px] hover:text-blue-500 duration-500  hover:bg-white font-semibold md:py-6 md:px-18 py-4 px-12 rounded-full flex mx-auto gap-2 items-center '>
            Generate Yours Now
                <FaArrowRight />
                </button>
                </Link>
