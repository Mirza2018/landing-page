...
export default function Features() {
    ...
    <div id="getStart" className="relative bg-gradient-to-b from-black via-gray-900 to-black text-white md:py-12 py-4 px-6 lg:mx-8 xl:mx-0">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row  items-center gap-[54px]">
        ...
        <div className="flex-1">
          ...
          <p className="2xl:text-[30px] xl:text-[28px] lg:text-[26px] md:text-[24px] text-[18px] md:leading-9 mb-8 font-semibold   leading-normal   ">
  ...
  <div className="rounded-lg shadow-lg text-center max-w-lg grid md:grid-cols-2 md:gap-[17px] gap-[9px] ">
    ...
    <div className="bg-gray-800 rounded-lg flex flex-col justify-around lg:px-4 xl:px-6 md:px-2">
      ...
      <p className=" text-[#aeaeae]  2xl:text-[18px] xl:text-[16px] lg:text-[15px] md:text-[14px] text-[12px] text-center font-semibold">
