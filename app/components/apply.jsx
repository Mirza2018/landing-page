...
const ApplicationForm = () => {
    ...
    return (
      ...
      <div className="pt-[85px] containerbg md:-mb-[100px]">
        ...
        <div className="absolute xl:w-[90vh] md:w-[50vh] w-[50%] h-[50vh] rounded-full bg-gradient-to-r from-blue-800 via-blue-700 to-blue-900
                opacity-70 blur-3xl -top-10 -z-20"></div>

            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 ">
              <div>
                <label htmlFor="Full Name" className="block text-white  2xl:text-[17.5px] md:text-[16px] text-[14px] z-10 pb-2">Full Name*</label>
                <input
                  id="name"
                  type="name"
                  placeholder="Full Name"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 pt-6">
              ...
              <div>
              <label htmlFor="socialMedia" className="block text-white   2xl:text-[17.5px]  text-[14px] z-10 pb-2">Social Media Handle</label>
              <input
                  id="socialMedia"
                  type="text"
                  placeholder="Social Media Handle"
